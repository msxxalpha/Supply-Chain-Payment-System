...
public class ReportsController(AppDbContext db):Controller
{
 ...
 public record SupplierRow(int Id,string Title,int Count,decimal Original,decimal Allocated,decimal Remaining,decimal Coverage,decimal AgeRatio,int Overdue,decimal Priority);
